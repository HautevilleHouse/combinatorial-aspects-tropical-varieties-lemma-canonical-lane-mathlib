import HautevilleHouse.CombinatorialAspectsTropicalVarietiesLemmaCanonicalLaneLean.PerelmanEntropy
...
theorem noncollapsing_closed_from_evidence
    ...
    (N : NoncollapsingPackage Epkg) (E : NoncollapsingEvidence N) : NoncollapsingClosed N := by
