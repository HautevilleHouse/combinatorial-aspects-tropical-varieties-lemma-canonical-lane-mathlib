import HautevilleHouse.CombinatorialAspectsTropicalVarietiesLemmaCanonicalLaneLean.PerelmanAnalyticProof
...
def HamiltonDeTurckCertificate.evidenceTerms {G : RiemannianCurvaturePackage}
    {F : RicciFlowPDEPackage G} (H : HamiltonDeTurckCertificate F) : HamiltonDeTurckEvidenceTerms H :=
